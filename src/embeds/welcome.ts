    ...
    .addFields(
      ...
      },
      {
        ...
        value: [
          ...
          '`Setup?` → Magguu-Profile übernehmen = Bake+Settings+Begleiter (WIM/Waypoint/HandyNotes/TTT/GTFO/BugSack/PGF). Magguu Settings = Overlay/QoL. Profile laden nur aktivieren (kein Bake). Setup-Buttons BigWigs/NSRT/EXBoss/Smart Reminders. WowUp PGF+Auctionator+Smart Reminders+MapNotes',
