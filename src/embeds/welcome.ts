    ...
    .addFields(
      ...
      },
      {
        ...
        value: [
          ...
          '`Setup?` → Magguu-Profile übernehmen = Bake+Settings+Begleiter. Magguu Settings = nur Overlay/QoL. Profile laden nur aktivieren (kein Bake-Reimport), außer Klassenlayouts. Pflicht Ellesmere+Klassenlayouts; Optional BigWigs/NSRT/WIM/Waypoint/EXBoss. WowUp PGF+Auctionator',
