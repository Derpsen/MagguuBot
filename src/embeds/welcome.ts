  ...
  return new EmbedBuilder()
    ...
    .setDescription(
      [
        ...
        '• Danach WoW neu starten oder `/reload` — Ellesmere-Startpopup wird übersprungen. `/mui` Setup: **Magguu-Profile übernehmen** (Install All = Bake+Look+Companions; Edit Mode MagguuUI einmal; Window & Tooltip Skins Precheck), **Magguu Settings** (Overlay/QoL only) | **Profile laden** (aktiviert nur, außer Klassenlayouts; kein Bake-Reimport). Scale `0.58` kommt mit Install All / Magguu Settings',
        '',
  ...
  return new EmbedBuilder()
    ...
    .setDescription(
      [
        ...
        '5. Einloggen: Ellesmere-Startpopup wird übersprungen, Magguu-Setup öffnet sich. `/mui` → **Setup**: goldenes **Magguu-Profile übernehmen** (Install All = Bake+Look+Companions; Edit Mode **MagguuUI** einmal; Window & Tooltip Skins Precheck), dann **Magguu Settings** (Overlay/QoL only) | **Profile laden** (nur aktivieren, außer Klassenlayouts; kein Bake-Reimport). Scale `0.58` kommt mit Install All / Magguu Settings (kein eigener Scale-Button). WowUp-Packs dort kopieren. Auf einem Alt erscheint ein Popup zum Laden der Profile',
        '',
        '**🔄  Updaten**',
    ...
    .addFields(
      ...
      },
      {
        ...
        value: [
          ...
          '`Setup?` → Install All = Bake+Look+Companions. Magguu Settings = Overlay/QoL only. Profile laden nur aktivieren (kein Bake-Reimport), außer Klassenlayouts. Pflicht Ellesmere+Klassenlayouts; Optional BigWigs/NSRT/WIM/Waypoint/EXBoss (Re-Import = Magguu-Look). WowUp PGF+Auctionator',
