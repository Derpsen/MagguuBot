  ...
  return new EmbedBuilder()
    ...
    .setDescription(
      [
        ...
        '• Danach WoW neu starten oder `/reload` — Ellesmere-Startpopup wird übersprungen. `/mui` Setup: Magguu-Profile übernehmen (Edit Mode MagguuUI einmal, Window & Tooltip Skins Precheck), Magguu Settings | Profile laden (aktiviert nur, außer Klassenlayouts). Scale `0.58` kommt mit Magguu-Profile übernehmen / Magguu Settings',
        '',
    ...
    .addFields(
      ...
      },
      {
        ...
        value: [
          ...
          '`Setup-Imports?` → Pflicht: Ellesmere + Klassenlayouts. Optional: BigWigs, NSRT, WIM, Waypoint, EXBoss (Authors; Re-Import ersetzt Magguu). Profile laden nur aktivieren, außer Klassenlayouts. WowUp-Starter EXBoss+EXCore; Optional PGF+Auctionator',
          '`Skinning?` → **NAMEN & FARBEN** (2 Spalten): Unit- und Party/Raid-Namen geteilt (1. Hälfte weiß, 2. Klasse/Reaktion) + klassenfarbige Keybind-Modifier. Magguu Settings schaltet das an',
          '`QoL?` → Death-Release, Co-Tank, Stealth/Stance, Spell-Alerts, Itemlevel Party/Raid (2P/4P), **Smart Tab**, Hide Services auf General, **Quick Focus**, Audio-Gerätewechsel am Ellesmere-Lautsprecher',
