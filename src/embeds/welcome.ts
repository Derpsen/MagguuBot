  ...
  return new EmbedBuilder()
    ...
    .setDescription(
      [
        ...
        '• Manuell: ZIP entpacken und **`MagguuUI` + `MagguuUI_Data` + `MagguuUI_Media`** in `Interface/AddOns` ersetzen',
  ...
  return new EmbedBuilder()
    ...
    .setDescription(
      [
        ...
        '3. **`MagguuUI`**, **`MagguuUI_Data`** und **`MagguuUI_Media`** nach:',
        '   `World of Warcraft/_retail_/Interface/AddOns/`',
        '4. Character-Select → AddOns → alle drei plus EllesmereUI aktiviert lassen',
        '5. Einloggen → `/mui` → **Setup** → 4K-Installation',
        '',
        '**🔄  Updaten**',
        '- Über den Addon-Manager reicht **Aktualisieren**',
        '- Manuell immer alle drei Ordner aus derselben ZIP ersetzen',
    ...
    .addFields(
      {
        ...
        value: [
          ...
          '`Was brauche ich?` → EllesmereUI + MagguuUI_Media. BigWigs/MRT sind optional',
