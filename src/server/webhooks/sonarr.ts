...
import { deletedFilesPresent, healthLevelForEvent, is4kQuality, isUpgradeFileDelete, sonarrPayloadSchema } from './schemas.js';
    ...
    case 'HealthRestored': {
      ...
      if (body.type) {
        await postOrEditLifecycleEmbed({
          ...common,
          lifecycleKey: `health:sonarr:${body.type.toLowerCase()}`,
